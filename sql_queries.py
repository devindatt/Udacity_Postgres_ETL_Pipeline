...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (songplay_id int, start_time time, \
...
time_table_create = "CREATE TABLE IF NOT EXISTS time (start_time time, hour int, day int, week int, \
